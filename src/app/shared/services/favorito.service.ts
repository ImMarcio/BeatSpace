...
export class FavoritoService {
  ...
  baseUrl = "http://localhost:8081/api/favoritos"
  ...
  constructor(private http : HttpClient) { }
    ...
    verificarFavorito(usuarioId: string, albumId: string): Observable<boolean> {
      return this.http.get<boolean>(`${this.baseUrl}/${usuarioId}/${albumId}`);
    }
